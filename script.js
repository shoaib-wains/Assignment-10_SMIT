...
alert(a);          //result=true
b="Apple">"Pineapple"
alert(b);          //result=false
c="2">"12"
alert(c);          //Result=true
undefined==null    //result=undefined
undefined===null   //result=undefined
null=="\n0\n"      //result=null
null===+"\n0\n"    //result=null
alert(null);
...
// Qno 5
// The result 12 is incorrect beacuse prompt takes value as a string by default,
// TO fix it we have to use "parseInt" data type before prompt function. This will take value as integer.
let a3=parseInt(prompt("Enter 1st Number"));
let b3=parseInt(prompt("Enter 2nd Number"));
let sum=a3+b3;
alert(sum);

// Qno 06
let a4=parseInt(prompt("Enter 1st Number"));
let b4=parseInt(prompt("Enter 2nd Number"));
let result=(a4+b4);
